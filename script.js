...
// //console.log(input);
//     document.getElementById("display").innerHTML += input; // += adds concatention 
//     document.getElementById("input").value = " "; // with equal symbol its assigning and without equal its get value
//     }
//     document.getElementById("addDigits").onclick = function() {
//      //console.log("addDigits clicked");   
//      // Get the sum of digits from the display field.
...
//         document.getElementById("display").innerHTML = runningTotal; //shows running total
//     }
